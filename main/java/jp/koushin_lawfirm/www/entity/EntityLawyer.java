...
public class EntityLawyer extends EntityMob {
	public EntityLawyer(World world) {
        ...
        this.tasks.addTask(4, new EntityAIAttackOnCollide(this, EntityAtsushi.class, 1.0D, true));
        ...
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityAtsushi.class, 0, false));
	...
	public void dropFewItems(boolean doesPlayerKill, int level) {
		...
		this.entityDropItem(new ItemStack(KoushinCore.blockTNTNuke, 1), 1);
	}
}
